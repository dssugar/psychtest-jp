          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-4">
            ...
            <DataBadge
              color={scaleInfo.psychologicalLayer === "trait" ? "green" :
                     ...
                     scaleInfo.psychologicalLayer === "outcome" ? "pink" : "orange"}
              size="md"
            >
              {scaleInfo.psychologicalLayer === "trait" ? "特性 (TRAIT)" :
               scaleInfo.psychologicalLayer === "state" ? "状態 (STATE)" :
               scaleInfo.psychologicalLayer === "outcome" ? "成果 (OUTCOME)" : "スキル (SKILL)"}
            </DataBadge>
          </div>
